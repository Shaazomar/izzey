...
export default function Summary({
  ...
  return (
    <div className="w-[290px] space-y-2 text-xs font-mono">
      {/* Subtotal */}
      <div className="flex justify-between px-3 py-1 text-slate-600">
      ...
      {/* Discount (if > 0) */}
      {discount && discount > 0 ? (
        <div className="flex justify-between px-3 py-1 text-rose-700 font-bold border-t border-slate-200 pt-1.5">
      ...
      {/* VAT (19%) */}
      <div className="flex justify-between px-3 py-1 text-slate-600 border-t border-slate-200 pt-1.5">
      ...
      <div className="bg-[#2E4036] text-white rounded-xl p-4 flex justify-between items-center shadow-md border border-[#2E4036]">
