...
export default function BaseTemplate({ data }: BaseTemplateProps) {
  ...
  return (
    <div 
      id="print-area"
      className="print-container bg-white w-[210mm] min-h-[297mm] p-[16mm] md:p-[18mm] mx-auto text-slate-900 flex flex-col justify-between box-border relative select-none font-body shadow-sm print:shadow-none print:border-none print:m-0"
    >
